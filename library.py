...
class maincode:
     ...
     def login(self):
         ...
         if self.ab!=None:
             ...
             self.under_fm=Frame(root,height=800,width=900,bg='#fff')
             self.under_fm.place(x=0,y=0)
             self.fm2=Frame(root,bg='#0f624c',height=80,width=900)
             self.fm2.place(x=0,y=0)

             #  lgo=Canvas(fm2,bg='#0f624c',height=300,width=100,bd=4,relief='flat')
             #  lgo.place(x=0,y=0)
     ...
     def cur(self):
             ...
             self.develop=Label(self.fm3,text='',bg='#fff',fg='blue',
             ...
             self.bt3 = Button(self.fm3, text='  Add Student', fg='#fff', bg='#ff0076', font=('Arial', 15, 'bold'),
                           width=170,height=0,bd=7,relief='flat',cursor='hand2',command=self.  addstu)
             self.bt3.place(x=40, y=70)
             ...
             self.bt7 = Button(self.fm3, text=' Search Books', fg='#fff', bg='#ff0076', font=('Arial', 15, 'bold'),
                          width=170,height=0,bd=8, relief='flat',cursor='hand2',command=self.search)
             self.bt7.place(x=40, y=190)
             ...
             self.bt8 = Button(self.fm3, text=' Show Students', fg='#fff', bg='#ff0076', font=('Arial', 15, 'bold'),
                          width=170,height=0,bd=9, relief='flat',cursor='hand2',command=self.showstu)
             self.bt8.place(x=40, y=250)
             ...
             self.bt10 = Button(self.fm3, text='Search  Student', fg='#fff', bg='#ff0076', font=('Arial', 15, 'bold'),
                          width=170,height=0,bd=9, relief='flat',cursor='hand2',command=self.searchstu)
             self.bt10.place(x=250, y=250)
             self.log10 = PhotoImage(file='bt8.png')
             ...
             self.bt12 = Button(self.fm3, text=' Delete student', fg='#fff', bg='#ff0076', font=('Arial', 15, 'bold'),
                          width=180,height=0,bd=7,relief='flat',cursor='hand2',command=self.delstudent)
             self.bt12.place(x=250, y=315)
             self.log12 = PhotoImage(file='bt5.png')
             self.bt12.config(image=self.log12, compound=LEFT)
             self.small_log12= self.log12.subsample(1, 1)
             self.bt12.config(image=self.small_log12)

  


             #---------------------Exit Button-----------------------
             self.bt7 = Button(self.fm3, text='  log Out', fg='#fff', bg='#ff0076', font=('Arial', 15, 'bold'),
                               width=170,
                          height=0, bd=7, relief='flat',cursor='hand2',command=self.code)
             self.bt7.place(x=250, y=190)
             self.log9 = PhotoImage(file='bt7.png')
             self.bt7.config(image=self.log9, compound=LEFT)
             self.small_log9 = self.log9.subsample(1, 1)
             self.bt7.config(image=self.small_log9)

             
             self.bt9 = Button(self.fm3, text='  EXIT', fg='#fff', bg='#ff0076', font=('Arial', 15, 'bold'),
                               width=170,
                          height=0, bd=7, relief='flat',cursor='hand2',command=self.exita)
             self.bt9.place(x=40, y=315)
             self.log9 = PhotoImage(file='bt8.png')
             self.bt9.config(image=self.log8, compound=LEFT)
             self.small_log11 = self.log8.subsample(1, 1)
             self.bt9.config(image=self.small_log11)
     ...
     def addbook(self):
         class temp(maincode):
             ...
             def book(self):
                 ...
                 self.lb=Label(self.fm1,text='Book Code',fg='black',bg='#fff',font=('Arial',10,'bold'))
                 ...
                 self.lb4= Label(self.fm1, text='Subject', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
                 self.lb4.place(x=70, y=210)
                 self.lb5 = Label(self.fm1, text='No of Book', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
             ...
             def submit1(self):
                 ...
                 try:
                      if (self.id and self.ttl and self.aut and self.edi and self.pri)=="":
                           ...
                           cursor.execute("INSERT INTO stbook(Book_Code,Title,Author,Subject,No_of_Book) values(?,?,?,?,?)",(self.id,
                                                                                                      self.ttl,self.aut,self.edi,self.pri))
                           dd.commit()
                           messagebox.showinfo("success","Book added successfully")
                 except sqlite3.IntegrityError:
                      messagebox.showinfo("success","Book already present")
     ...
     def addstu(self):
         class addstudent(maincode):
             ...
             def student(self):
                 ...
                 self.fm=Frame(root,bg='#a7ecd9',width=900,height=390)
                 self.fm.place(x=0,y=110)
                 self.fm1=Frame(self.fm,bg='#fff',width=500,height=400,bd=5,relief='flat')
                 self.fm1.place(x=200,y=15)
                 self.backbt = Button(self.fm, width=60, bg='#a7ecd9',activebackground='#a7ecd9', bd=0, relief='flat',\
                                                                                                 command=self.cur)
                 self.backbt.place(x=0, y=0)
                 ...
                 self.f=Frame(self.fm1,bg='#0f624c',width=490,height=35)
                 self.f.place(x=0,y=0)
                 self.ll=Label(self.f,text='ADD STUDENT',fg='#fff',bg='#0f624c',font=('Arial',12,'bold'))
                 self.ll.place(x=200,y=6)
                 self.lb=Label(self.fm1,text='Lib ID',fg='black',bg='#fff',font=('Arial',10,'bold'))
                 self.lb.place(x=70,y=90)
                 self.lb2 = Label(self.fm1, text='SUDENT NAME', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
                 self.lb2.place(x=70, y=130)
                 self.lb3 = Label(self.fm1, text='Student Class', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
                 self.lb3.place(x=60, y=170)
                 self.lb4= Label(self.fm1, text='PHONE_NO', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
                 self.lb4.place(x=70, y=210)
                 self.lb5 = Label(self.fm1, text='ADDRESS', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
                 self.lb5.place(x=70, y=250)
                 self.lb6 = Label(self.fm1, text='Email', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
                 self.lb6.place(x=70, y=290)
                 

                 #-------------------------------Entry-------------------------------------

                 self.a1=Entry(self.fm1,width=25,bd=4,relief='groove',font=('arial',12,'bold'))
                 self.a1.place(x=180,y=88)
                 self.a2=Entry(self.fm1,width=25,bd=4,relief='groove',font=('arial',12,'bold'))
                 self.a2.place(x=180,y=130)
                 self.a3=Entry(self.fm1,width=25,bd=4,relief='groove',font=('arial',12,'bold'))
                 self.a3.place(x=180,y=170)
                 self.a4=Entry(self.fm1,width=25,bd=4,relief='groove',font=('arial',12,'bold'))
                 self.a4.place(x=180,y=210)
                 self.a5=Entry(self.fm1,width=25,bd=4,relief='groove',font=('arial',12,'bold'))
                 self.a5.place(x=180,y=250)
                 self.a6=Entry(self.fm1,width=25,bd=4,relief='groove',font=('arial',12,'bold'))
                 self.a6.place(x=180,y=290)
                 

                 self.bt=Button(self.fm1,text='Submit',width=41,bg='red',fg='#fff',font=('Arial',10,'bold'),bd=5,
                          relief='flat',command=self.submit1)
                 self.bt.place(x=70,y=330)
             ...
             def submit1(self):
                  self.rollno=self.a1.get()
                  self.studentname=self.a2.get()
                  self.studentclass=self.a3.get()
                  self.phoneno=self.a4.get()
                  self.email=self.a5.get()
                  self.course=self.a6.get()
                  
                  
                  dc=sqlite3.connect('students.db')
                  cursor=dc.cursor()
                  try:
                       if (self.rollno and self.studentname and self.studentclass and self.phoneno and self.email and self.course)=="":
                            messagebox.showinfo("Error","Fields cannot be empty.")
                       else:
                            cursor.execute("insert into student (Lib_ID,Name,CLASS,PHONE_NO,ADDRESS,Email)values (?,?,?,?,?,?)",(self.rollno,self.studentname,self.studentclass,self.phoneno,self.email,self.course));
                            dc.commit()
                            messagebox.showinfo("Success","STUDENT added successfully")
                  except sqlite3.IntegrityError:
                       messagebox.showinfo("Error","STUDENT RECORD is already present.")
     ...
     def issuebook(self):
         class test(maincode):
              ...
              def issue(self):
                  ...
                  self.lb = Label(self.fc, text='Lib-ID', bg='#fff', fg='black', font=('Arial', 10, 'bold'))
              ...
              def check(self):
                  ...
                  self.b=self.em2.get()
                  cursor=dc.cursor()
                  cursor.execute("SELECT * FROM student WHERE Lib_ID='"+self.ai+"' or Lib_ID='"+self.b+"'")
                  ...
                  if self.var!=None:
                        ...
                        self.tt=Label(self.fr,text='Book Code',bg='#fff',fg='black',font=('arial',10,'bold'))
              ...
              def data(self):
                   ...
                   cursor=dd.cursor()
                   cursor.execute("SELECT * FROM stbook WHERE Book_Code='"+self.vva+"' and Title='"+self.vvb+"'")
                   ...
                   if self.value!=None:
                        if self.max==0:
                              ...
                              self.lb = Label(self.boot, text='Subject', bg='#fff', fg='black', font=('Arial', 10,
                                                                                                    'bold'))
                        ...
                        if self.max==1:
                              ...
                              self.lbc = Label(self.boot, text='Subject', bg='#fff', fg='black', font=('Arial', 10,
                                                                                                    'bold'))
              ...
              def issued(self):
                    ...
                    if self.n<=3:
                       book=dc.cursor()
                       book.execute("UPDATE student SET No_book='"+str(self.n)+"' WHERE Lib_ID='"+self.ai+"' or "
                                                                                                             "Lib_ID='"+self.b+"' ")
                       dc.commit()

                    comm=dc.cursor()
                    comm.execute("UPDATE student SET From_date='"+str(self.x)+"', To_date='"+str(self.datecon)+"' "
                                                                                                               "WHERE Lib_ID='"+self.ai+"' or Lib_ID='"+self.b+"'")
                    dc.commit()
              ...
              def mail(self):
                    ...
                    cursor=dc.cursor()
                    cursor.execute("SELECT * FROM student WHERE Lib_ID='"+self.baby+"'")
                    self.var=cursor.fetchone()
                    sender = "rs9012896@gmail.com"
                    reciever =self.var[5]
     ...
     def edit(self):
         class editing(maincode):
               def edbooks(self):
                     ...
                     self.label3=Label(self.fm1,text='Book Code ',bg='#fff',fg='black',font=('arial',10,'bold'))
     ...
     def return_book(self):
         class retu(maincode):
             ...
             def __init__(self):
                 ...
                 self.ed.place(x=0, y=0)
                 self.lac = Label(self.ed, text='RETURN', bg='#0f624c', fg='#fff', font=('Arial', 12, 'bold'))
                 self.lac.place(x=175, y=5)
                 self.label8 = Label(self.f1, text='Lib ID', bg='#fff', fg='black', font=('arial', 10, 'bold'))
             ...
             def retbook(self):
                 ...
                 cursor=dc.cursor()
                 cursor.execute("SELECT * FROM student WHERE Lib_id='"+self.entry+"'")
                 dc.commit()
                 ...
                 if self.data!=None:
                     ...
                     cursor.execute("UPDATE student SET submit_date='" + str(
                         self.get_date) + "' WHERE Lib_ID='" + self.entry + "'")
                     dc.commit()
                 ...
                 #-----------------between two date calculate days---------------------
                         ...
                         cursor1.execute("UPDATE student SET From_date='',To_date='',submit_date='',No_book='',"
                                         "Charge='"+str(self.charge)+"' WHERE Lib_ID='"+self.entry+"'")
                         dc.commit()
     ...
     def delete(self):
         class dele(maincode):
               def deleteee(self):
                     ...
                     self.lac.place(x=175, y=5)
                     self.label8 = Label(self.f1, text='Book Code', bg='#fff', fg='black', font=('arial', 10, 'bold'))
                     self.label8.place(x=85, y=65)
                     self.entry4 = Entry(self.f1, width=30, bd=4, relief='groove', font=('arial', 8, 'bold'))
                     self.entry4.place(x=188, y=65)
                     ...
                     if len(self.entry4.get()) == 0:
                          ...
                          if c:
                               ...
                               try:
                                    dd = sqlite3.connect('storebook.db')
                                    cursor = dd.cursor()
                                    cursor.execute("DELETE FROM stbook WHERE Book_Code = ?",[self.entry4.get()])
     ...
     def searchstu(self):
         ...
         class dem(maincode):
             def demdata(self):
                 ...
                 self.fc = Frame(root, bg='#a7ecd9', width=900, height=400)
                 ...
                 self.lac = Label(self.edm, text='SEARCH STUDENT ', bg='#0f624c', fg='#fff', font=('Arial', 12, 'bold'))
                 self.lac.place(x=175, y=5)
                 self.label8 = Label(self.fc1, text='LIb ID', bg='#fff', fg='black', font=('arial', 10, 'bold'))
                 self.label8.place(x=85, y=65)
             ...
             def srch(self):
                 ...
                 cursor=dc.cursor()
                 cursor.execute("SELECT * FROM student WHERE Lib_ID='"+self.emp+"'")
                 dc.commit()
                 ...
                 if self.srval!=None:
                     ...
                     self.top.geometry("300x500+600+300")
                     ...
                     self.lb1 = Label(self.top, text='Name :-', bg='black', fg='blue', font=('arial', 12, 'bold'))
                     ...
                     self.lb3 = Label(self.top, text='Class :-', bg='black', fg='blue', font=('arial', 12, 'bold'))
                     self.lb3.place(x=20, y=160)
                     self.lb4 = Label(self.top, text=self.srval[2], bg='black', fg='blue', font=('arial', 12, 'bold'))
                     self.lb4.place(x=120, y=160)

                     self.lb5 = Label(self.top, text='PHONE NO :-', bg='black', fg='blue', font=('arial', 12, 'bold'))
                     self.lb5.place(x=15, y=240)
                     self.lb6 = Label(self.top, text=self.srval[4], bg='black', fg='blue', font=('arial', 12, 'bold'))
                     self.lb6.place(x=120, y=240)

                     self.lb7 = Label(self.top, text='ADDRESS :-', bg='black', fg='blue', font=('arial', 12, 'bold'))
                     self.lb7.place(x=20, y=320)
                     self.lb8 = Label(self.top, text=self.srval[3], bg='black', fg='blue', font=('arial', 12, 'bold'))
                     self.lb8.place(x=120, y=320)

                     self.lb9 = Label(self.top, text='EMAIL :-', bg='black', fg='blue', font=('arial', 12, 'bold'))
                     self.lb9.place(x=20, y=400)
                     self.lb10 = Label(self.top, text=self.srval[5], bg='black', fg='blue', font=('arial', 12, 'bold'))
                     self.lb10.place(x=120, y=400)
     ...
     def showstu(self):
         ...
         class tst(maincode):
             def __init__(self):
                 ...
                 self.lbn=Label(self.popframe,bg='#0f624c',text='STUDENT INFORMATION',fg='#fff',font=('arial',10,
                                                                                                      'bold'))
                 ...
                 self.book_table=ttk.Treeview(self.table_frame,columns=("Lib_ID","Name","Class","ADDRESS",
                                                                           ),
                 ...
                 self.book_table.heading("Lib_ID",text="Lib_ID")
                 self.book_table.heading("Name", text="NAME")
                 self.book_table.heading("ADDRESS", text="ADDRESS")
                 self.book_table.heading("Class", text="Class")
                
                 self.book_table['show']='headings'
                 self.book_table.column("Lib_ID",width=200)
                 self.book_table.column("Name", width=200)
                 self.book_table.column("Class", width=200)
                 self.book_table.column("ADDRESS", width=120)
     ...
     def delstudent(self):
         class ddel(maincode):
               def delet(self):
                     ...
                     self.ed = Frame(self.f1, bg='#0f624c', bd=0, relief='flat', width=490, height=35)
                     self.ed.place(x=0, y=0)
                     self.lac = Label(self.ed, text='DELETE students ', bg='#0f624c', fg='#fff', font=('Arial', 12,'bold'))
                     self.lac.place(x=175, y=5)
                     self.label8 = Label(self.f1, text='LIB Code', bg='#fff', fg='black', font=('arial', 10, 'bold'))
                     self.label8.place(x=85, y=65)
                     self.entry8 = Entry(self.f1, width=30, bd=4, relief='groove', font=('arial', 8, 'bold'))
                     self.entry8.place(x=188, y=65)
                     self.button9 = Button(self.f1, text='Delete', bg='#0f624c', fg='#fff', width=24, height=0,
                                  font=('Arial', 10, 'bold'),command=self.deldata)
                     self.button9.place(x=140, y=120)
               ...
               def deldata(self):
                     self.a=self.entry8.get()
                     dc=sqlite3.connect('student')
                     cursor=dc.cursor()
                     if len(self.entry8.get()) == 0:
                          messagebox.showerror("Error","Please Enter The Lib Id")
                     else:
                         dc = sqlite3.connect('students.db')
                         cursor = dc.cursor()
                         cursor.execute("DELETE FROM student WHERE Lib_ID = ?",[self.entry8.get()])
                         messagebox.showinfo('Remove', 'Succesfully Removed')
                         dc.commit()
                         dc.close()
     ...
     def search(self):
         class demt(maincode):
             def delmdata(self):
                 ...
                 self.lac.place(x=175, y=5)
                 self.label8 = Label(self.fc1, text='Book Code', bg='#fff', fg='black', font=('arial', 10, 'bold'))
                 self.label8.place(x=85, y=65)
                 self.entryl= Entry(self.fc1, width=30, bd=4, relief='groove', font=('arial', 8, 'bold'))
                 self.entryl.place(x=188, y=65)
                 self.butto = Button(self.fc1, text='Search', bg='#0f624c', fg='#fff', width=24, height=0,
             ...
             def srch(self):
                 self.emp=self.entryl.get()
                 cursor=dd.cursor()
                 cursor.execute("SELECT * FROM stbook WHERE Book_Code='"+self.emp+"'")
                 dd.commit()
                 self.srval=cursor.fetchone()
                 if self.srval!=None:
                     ...
                     self.top.title("Library System")
                     self.top.iconbitmap("aa.ico")
                     self.top.geometry("300x400+600+300")
                     self.top.resizable(0, 0)
                     self.top.configure(bg='black')
                     ...
                     self.lb5 = Label(self.top, text='Subject :-', bg='black', fg='blue', font=('arial', 12, 'bold'))
                     self.lb5.place(x=40, y=240)
                     self.lb6 = Label(self.top, text=self.srval[3], bg='black', fg='blue', font=('arial', 12, 'bold'))
                     self.lb6.place(x=120, y=240)

                     self.lb7 = Label(self.top, text='NO OF Books :-', bg='black', fg='blue', font=('arial', 12, 'bold'))
                     self.lb7.place(x=8, y=320)
                     self.lb8 = Label(self.top, text=self.srval[4], bg='black', fg='blue', font=('arial', 12, 'bold'))
    ...
    #-------------------------------------------SHOW BOOKS_------------------------------------------------
     ...
     def show(self):
         class tst(maincode):
             def __init__(self):
                 ...
                 self.scroll_x=Scrollbar(self.table_frame,orient=HORIZONTAL)
                 self.scroll_y=Scrollbar(self.table_frame,orient=VERTICAL)
                 self.book_table=ttk.Treeview(self.table_frame,columns=("Book Code","Title","Author","Subject",
                                                                           "No of Book"),
                                      xscrollcommand=self.scroll_x.set,yscrollcommand=self.scroll_y.set)
                 self.scroll_x.pack(side=BOTTOM,fill=X)
                 self.scroll_y.pack(side=RIGHT, fill=Y)
                 ...
                 self.book_table.heading("Book Code",text="Book Code")
                 self.book_table.heading("Title", text="Title")
                 self.book_table.heading("Author", text="Author")
                 self.book_table.heading("Subject", text="Subject")
                 self.book_table.heading("No of Book", text="No of Book")
                 self.book_table['show']='headings'
                 self.book_table.column("Book Code",width=200)
                 self.book_table.column("Title", width=200)
                 self.book_table.column("Author", width=200)
                 self.book_table.column("Subject", width=120)
                 self.book_table.column("No of Book", width=110)
                 self.book_table.pack(fill=BOTH,expand=1)
                 self.fetch_data()
     ...
     def exita(self):
          ...
          if answer=="yes":
               messagebox.showinfo("THANKYOU","THIS PROGRAM IS DEVELOPED BY ONLY AND ONLY RAHUL THANKS")
               root.destroy() 
